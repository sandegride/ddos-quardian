	...
	if d.Store != nil {
		...
		d.Store.Add(dashboard.WindowRecord{
			...
			Metrics: dashboard.WindowMetrics{
				...
				TCPSYN:              ws.TCPSYN,
				BackendRequests:     ws.BackendRequests,
				Backend2xx:          ws.Backend2xx,
				Backend4xx:          ws.Backend4xx,
				Backend5xx:          ws.Backend5xx,
				BackendAvgLatencyMs: ws.BackendAvgLatencyMs(),
				BackendSuccessRate:  ws.BackendSuccessRate(),
			},
